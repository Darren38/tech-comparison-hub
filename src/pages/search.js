...
import { icon, deviceCard, docCard, emptyState, sourceLink, tierBadge, pageTrail } from '../ui/components.js';
    ...
    html: html`<div class="stack-lg">
      ...
      <header class="stack">
        ...
        <form class="searchbox searchbox--hero" role="search" data-page-search>
          ${icon('search', { size: 22 })}
          <input type="search" name="q" value="${q}" placeholder="Device, chipset, brand, reviewer or a comparison…" autocomplete="off" aria-label="Search" />
      ...
      ${!q
        ? emptyState('Search the hub', 'Type a device (“S26 Ultra”), a chip (“Dimensity 9500”), a brand, a reviewer, or a comparison such as “OnePlus 15 vs Galaxy S26 Ultra for battery”.')
        : groups.length
